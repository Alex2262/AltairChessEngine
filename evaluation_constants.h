...
constexpr SCORE_TYPE CANONICAL_PIECE_VALUES[6] = {100, 310,340, 500, 9000, 0};
...
constexpr SCORE_TYPE PIECE_VALUES[6] = {S( 112, 162), S( 474, 446), S( 457, 433), S( 664, 785), S(1468,1424), S(   0,   0)};

constexpr SCORE_TYPE PIECE_SQUARE_TABLES[6][64] = {
        {
                S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63),
                S( 117, 142), S(  96, 132), S(  59, 109), S( 101,  57), S(  32,  83), S( 118, 120), S( -49, 182), S(   5, 190),
                S( -12,  63), S(   6,  48), S(  22,  18), S(  32, -14), S(  44, -19), S(  15,  23), S( -12,  53), S( -36,  89),
                S( -14,  21), S(  12,  -4), S(   2, -10), S(  18, -32), S(  21, -21), S(  14,  -6), S(  20,  -1), S( -41,  23),
                S( -16,   3), S(  -8,  -7), S(  -1, -20), S(  10, -23), S(   9, -20), S(  12, -13), S(  -9,  -9), S( -44,   4),
                S( -20,  -8), S(  -2, -18), S(  -4, -19), S(   2, -19), S(  13,  -6), S(   5, -19), S(  23, -25), S( -28,  -8),
                S( -22,   5), S(  -4, -11), S( -18,   4), S(  -7, -10), S( -10,  10), S(  21, -19), S(  29, -18), S( -28,  -1),
                S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63), S( -29, -63)
        },
        {
                ...
                S( -10, -43), S(   7,   1), S(  23,   9), S(  26,  31), S(  38,  22), S(  26,   1), S(  23, -10), S(  -7,  -4),
        ...
        {
                S(   9,  16), S(  11,  19), S( -27,  28), S( -29,  30), S(  -1,  20), S(  -8,  21), S( -31,  24), S(  53,  10),
                ...
                S( -33, -10), S( -18,  -6), S( -25,  -4), S( -17,  -3), S( -21,   1), S( -10, -13), S(   1,  -9), S( -27, -16),
                S( -39, -13), S( -15, -16), S( -25,  -3), S( -14, -10), S( -10, -12), S(  -3, -19), S(   1, -25), S( -80,   0),
                S(  -1, -10), S(   0, -10), S(   7, -12), S(  14, -22), S(   8, -20), S(   4,  -7), S( -18,  -7), S(  -7, -30)
        },
        {
                S( -52,  -1), S( -65,  50), S( -33,  28), S( -22,  -9), S(  -3,  13), S(   4,  15), S(  38, -18), S(   9,   2),
                ...
                S(  27, -41), S(  45, -60), S(  48, -72), S(  35, -25), S(  35, -40), S(  43, -76), S(  33, -71), S(   4, -39),
                S(  59, -58), S(  42, -55), S(  52, -52), S(  45,  40), S(  39, -52), S(  29, -79), S(  46, -84), S(  -1, -70)
        },
        {
                S(-270, -68), S( 150, -69), S( 194, -56), S(  85, -59), S(-212,   0), S( -31,  21), S(  70, -11), S( -21, -27),
                S( 115, -47), S( 135,   4), S( 131,  13), S(  93,  -1), S(  61,   0), S( 137,  21), S(  29,  33), S(-156,  24),
                S(  53,   3), S( 165,   7), S( 194,  15), S(  75,   4), S( 155, -10), S( 222,  29), S( 227,  25), S( -12,  18),
                ...
                S( -99,   1), S( -12,  12), S(  21,  23), S(  65,  10), S(  85,   4), S(  96,  19), S(  68,   8), S( -24,  -2),
...
constexpr SCORE_TYPE PASSED_PAWN_BONUSES[3][8] = {
        {S(   0,   0), S( -10,  28), S( -24,  39), S( -24,  69), S(  -6, 101), S(  25, 181), S(  66, 206), S(   0,   0)},
        {S(   0,   0), S(   0,   0), S(  -3,  33), S(  -6,  57), S(  27, 108), S(  84, 215), S( 354, 192), S(   0,   0)},
        {S(   0,   0), S(   0,   0), S(  39,  38), S( -14,  42), S(  73,  67), S( 140, 151), S( 244, 117), S(   0,   0)}
};
...
constexpr SCORE_TYPE PASSED_PAWN_BLOCKERS_2[6][8] = {
        ...
        {S(   0,   0), S(   0,   0), S(   0,   0), S(  14, -21), S(  28, -23), S( -10,  19), S(   4,   7), S(  32, -52)},
        {S(   0,   0), S(   0,   0), S(   0,   0), S(  17,  -9), S(  -2, -10), S(  -2, -14), S(  24, -37), S(  12,  95)},
        {S(   0,   0), S(   0,   0), S(   0,   0), S( 133,  -7), S(  34,  -2), S( -77,   3), S( -32, -35), S(  12,-117)}
};


constexpr SCORE_TYPE PHALANX_PAWN_BONUSES[8] = {S(   0,   0), S(   0, -14), S(   1,  -8), S(  16,   4), S(  42,  63), S(  33, 152), S(  75, 390), S(   0,   0)};
...
constexpr SCORE_TYPE PIECE_THREATS[6][6] = {
        ...
        {S(  11,  44), S(  -1,  21), S( -40,  40), S( -51,  37), S(-252,  50), S(   0,   0)}
};


constexpr SCORE_TYPE KING_RING_ATTACKS[2][6] = {
        {S(  43, -10), S(  28, -13), S(  38,  -5), S(  41,  -8), S(  36,   5), S(   0,   0)},
        {S(  28,  -9), S(  28,  -2), S(  29,  -3), S(  21,  -2), S(  26,   9), S(   0,   0)}
};


constexpr SCORE_TYPE TOTAL_KING_RING_ATTACKS[30] = {S(  71,   6), S(  42,  -5), S(  10,  -5), S( -18,  -1), S( -38,   4), S( -47,   5), S( -57,   3), S( -63,   6), S( -65,   5), S( -66,   6), S( -65,   6), S( -76,   8), S( -54,  -2), S( -49,  -1), S( -27, -18), S( -60,   4), S( -16, -26), S(  73, -79), S(  85, -64), S( 127, -88), S( -22,  -1), S( 261,-145), S( 115, -96), S( 153,-254), S(  67, -89), S( 319, 457), S( 117, 170), S( 255, 361), S(   4,   6), S(   1,   1)};
