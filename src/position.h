...
public:
    ...
    inline void ensure_stable() { nnue_state.reset_nnue(*this); };
    inline Square get_king_pos(Color color) const { return lsb(get_pieces(KING, color)); }
    inline bool is_attacked(Square square, Color color) const;
    inline void remove_piece(Piece piece, Square square);
